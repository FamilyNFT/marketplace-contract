    ...
    LSP8MarketplaceEscrow
{
    ...
    //     )
    // {
    //     address offerLSP8Owner = ILSP8IdentifiableDigitalAsset(offerLSP8Address)
    //         .tokenOwnerOf(offerTokenId);
    ...
    //     offerCreatorHasEnoughLSP7Balance(
    //         LSP8Address,
    //         tokenId,
    //         LSP7Address,
    //         offerCreator
